...
class Plot2D(object):
    ...
    def __init__(self):
        ...
        ## Imagen de fondo
        self.img = QtGui.QImage('001Znula.png')
        try:
        ...
        self.win = pg.GraphicsWindow(title = "Ondas Estacionarias - Impedancia cero")
        ...
        dictEjeX = {-3:'3\u03BB',-2.5:'2.5\u03BB',-2 :'2\u03BB',-1.5:'1.5\u03BB',-1:'\u03BB',-0.5:'0.5\u03BB', 0: ""}
        ...
        self.ejeLambda.setStyle(stopAxisAtTick = (False,True))
        ...
        self.ejeLambda2.setStyle(stopAxisAtTick = (False,True))
        ...
        self.ejeLambda3.setStyle(stopAxisAtTick = (False,True))
        ...
        self.fondo1.setRect(pg.QtCore.QRectF(-0.18, -2, 1.75, 4)) # Dimensiones de imagen dentro del grafico (ajustado a mano)
        ...
        self.fondo2.setRect(pg.QtCore.QRectF(-0.18, -0, 1.75, 5)) # Dimensiones de imagen dentro del grafico (ajustado a mano)
        ...
        self.fondo3.setRect(pg.QtCore.QRectF(-0.18, -2, 1.75, 4)) # Dimensiones de imagen dentro del grafico (ajustado a mano)
